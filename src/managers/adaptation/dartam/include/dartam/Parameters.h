...
struct ConfigurationSpaceParams {
	unsigned MAX_SERVERS = 12;
	unsigned MAX_DIMMER  = 10;
};
...
struct AdaptationManagerParams {
	...
	std::string PRISM_TEMPLATE = "../managers/adaptation/dartam/include/dartam/model/dart2";
